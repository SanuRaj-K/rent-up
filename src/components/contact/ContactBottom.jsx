  ...
  return (
    <div>
      <div className=" px-5  flex flex-col md:flex-row  md:justify-between bg-primary py-10  items-center">
        ...
        <div>
          <div className=" text-[20px] mt-5 md:mt-0  px-5 cursor-pointer  text-primary     bg-white hover:border-none transition-all duration-300 text-center py-3  border-[#E5F5EC] border-[5px] rounded-full">
            Contact Us Today 
          </div>
        </div>
      </div>
